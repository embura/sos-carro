...
-- Primeiro, vamos usar categorias genéricas que certamente existem no ENUM
-- As categorias típicas são: 'outros', 'eletrica', 'hidraulica', 'pintura', etc.
-- Se houver erro, execute primeiro: SELECT unnest(enum_range(NULL::service_category));

...
-- IMPORTANTE: Se houver erro de ENUM, execute primeiro:
-- SELECT unnest(enum_range(NULL::service_category));
-- para ver as categorias válidas e ajuste o script abaixo
...
VALUES 
  (gen_random_uuid(), NULL, 'Silva Reformas', ARRAY['outros']::service_category[], 'Especialista em reformas residenciais e comerciais com mais de 10 anos de experiência.', 'Rua das Flores, 123', 'São Paulo', 'SP', '01234-567', 'Brasil', '(11) 98765-4321', true, true, 4.8, now(), now()),
  (gen_random_uuid(), NULL, 'Costa Elétrica', ARRAY['eletrica']::service_category[], 'Serviços elétricos completos para residências e empresas. Segurança e qualidade garantidas.', 'Av. Paulista, 456', 'São Paulo', 'SP', '01310-100', 'Brasil', '(11) 97654-3210', true, true, 4.9, now(), now()),
  (gen_random_uuid(), NULL, 'Oliveira Hidráulica', ARRAY['hidraulica']::service_category[], 'Soluções em hidráulica, instalações e reparos. Atendimento rápido e eficiente.', 'Rua Augusta, 789', 'São Paulo', 'SP', '01305-000', 'Brasil', '(11) 96543-2109', false, true, 4.5, now(), now()),
  (gen_random_uuid(), NULL, 'Santos Pintura', ARRAY['pintura']::service_category[], 'Pintura residencial e comercial, acabamentos finos e texturas. Orçamento sem compromisso.', 'Rua Consolação, 321', 'São Paulo', 'SP', '01302-000', 'Brasil', '(11) 95432-1098', true, true, 4.7, now(), now()),
  (gen_random_uuid(), NULL, 'Ferreira Construtora', ARRAY['construcao']::service_category[], 'Construção e reforma de imóveis. Do alicerce ao acabamento, cuidamos de tudo.', 'Av. Faria Lima, 654', 'São Paulo', 'SP', '01452-000', 'Brasil', '(11) 94321-0987', true, true, 4.9, now(), now()),
  (gen_random_uuid(), NULL, 'Almeida Jardinagem', ARRAY['jardinagem']::service_category[], 'Manutenção de jardins, paisagismo e poda de árvores. Deixe seu jardim lindo!', 'Rua Oscar Freire, 987', 'São Paulo', 'SP', '01426-000', 'Brasil', '(11) 93210-9876', false, true, 4.6, now(), now()),
  (gen_random_uuid(), NULL, 'Rodrigues Limpeza', ARRAY['limpeza']::service_category[], 'Serviços de limpeza pós-obra, residencial e comercial. Produtos de qualidade.', 'Av. Rebouças, 147', 'São Paulo', 'SP', '05401-000', 'Brasil', '(11) 92109-8765', true, true, 4.8, now(), now()),
  (gen_random_uuid(), NULL, 'Martins Ar Condicionado', ARRAY['climatizacao']::service_category[], 'Instalação, manutenção e reparo de ar condicionado. Todas as marcas.', 'Rua da Consolação, 258', 'São Paulo', 'SP', '01301-000', 'Brasil', '(11) 91098-7654', true, true, 4.7, now(), now()),
  (gen_random_uuid(), NULL, 'Carvalho Marcenaria', ARRAY['marcenaria']::service_category[], 'Móveis sob medida, armários, cozinhas planejadas. Madeira de qualidade.', 'Av. Ibirapuera, 369', 'São Paulo', 'SP', '04029-000', 'Brasil', '(11) 90987-6543', false, true, 4.4, now(), now()),
  (gen_random_uuid(), NULL, 'Pereira Serralheria', ARRAY['serralheria']::service_category[], 'Portões, grades, estruturas metálicas. Serviço personalizado e durável.', 'Rua Vergueiro, 741', 'São Paulo', 'SP', '01504-000', 'Brasil', '(11) 89876-5432', true, true, 4.6, now(), now());
...
SELECT id, business_name, categories_offered, city, state, phone, is_verified, rating FROM providers ORDER BY created_at;
